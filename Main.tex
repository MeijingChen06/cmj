...
\documentclass[doctor,oneside,UTF8,hyperref]{./Template/scuthesis}
\usepackage{fancyvrb}
\usepackage{xcolor}
\usepackage{dirtree}
\usepackage{textcomp}
...
\author{陈美静}
\ENGauthor{Meijing Cheng}
\accomplishdate{2026年6月}
\school{网络空间安全学院}
\supervisor{刘~~~颖{\quad}教授}
\ENGsupervisor{Prof. He}
\major{网络空间安全}
\ENGmajor{Cyber Science and Technology}
\direction{网络空间安全}
\ENGdirection{Direction Name}
\defensedate{2026年6月}

\keywords{key word1，key word2\LaTeX，\CTeX}
